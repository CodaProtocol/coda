...
create table point_record_table(ID SERIAL primary key, file_name character varying, blockchain_epoch bigint, block_producer_key character varying, 
				blockchain_height bigint, state_hash character varying, created_at timestamp, amount int, node_id int, bot_log_id int,
