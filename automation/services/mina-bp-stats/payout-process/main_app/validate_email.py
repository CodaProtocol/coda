                      ...
                      <p class="rules">
                          <ul class="dashed rules">
                            <li>According to our system, you are required to send back at least 
                                <ul class="dashed">
                                    <li><span class="bg-warning">""" + f"""{payouts_df.iloc[i, 2]}""" + """</span> MINA to this address: <span class="bg-warning">""" + f"""{payouts_df.iloc[i, 0]}""" + """</span>
                                    </li>
