...
def send_mail(epoch_id, delegate_record_df):
    ...
    for i in range(payouts_df.shape[0]):
        ...
        html_content = """<!DOCTYPE html> <html lang="en"> <head> <meta charset="UTF-8" /> <meta 
        http-equiv="X-UA-Compatible" content="IE=edge" /> <meta name="viewport" content="width=device-width, 
        initial-scale=1.0" /> <title>Email Template</title> <link rel="stylesheet" 
        ...
        ></script> <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.4.0/font/bootstrap
        -icons.css" /> <link rel="preconnect" href="https://fonts.gstatic.com" /> <link 
        href="https://fonts.googleapis.com/css2?family=IBM+Plex+Sans:ital,wght@0,100;0,200;0,300;0,400;0,500;0,600;0,
        700;1,100;1,200;1,300;1,400;1,500;1,600;1,700&display=swap" rel="stylesheet" /> <!-- <link rel="stylesheet" 
        href="assets/css/emailTemplate.css" /> --> <style>a { text-decoration: underline; } ul { list-style-type: 
        none; } ul li:before { content: "\2212"; position: absolute; margin-left: -20px; } ul li ol li:before { 
        content: ""; position: absolute; margin-left: -20px; } ul li ol li ul li:before { content: "\2212"; position: 
        absolute; margin-left: -20px; } .bg-warning { background-color: unset !important; } .container { font-family: 
        "IBM Plex Sans", sans-serif; font-style: normal; font-weight: light; /* font-size: 10px; */ margin: 4rem; /* 
        margin-top: 5rem; */ } .inner-container { padding: 0px; margin: 10px; } .dynamic-text-color { color: #ec3a61; 
        } .rules { padding-right: 6rem; } .warning-icon { background-color: #f5f846; } p i .warning { max-width: 
        256px; max-height: 256px; background-image: url(data:image/svg+xml;base64,
        PD94bWwgdmVyc2lvbj0iMS4wIiBlbmNvZGluZz0iaXNvLTg4NTktMSI
        ); }</style> </head> <body> <div class="container"> <div class="inner-container"> <header class="header-container text-center"> </header> <section class="px-5"> <p>Dear Mina community member,</p> <p>Thank you for your participation in the Mina Foundation delegation program. <span class="dynamic-text-color"> You are receiving a <br>delegation from two addresses of the Mina Foundation. This email is related to the delegation from <br> address <span class="bg-warning text-dark">""" + f"""{payouts_df.iloc[i, 0]}""" + """</span>.</span></p> 
                      ...
                      <p class="rules">
                          <ul class="dashed rules">
                            <li>According to our system, you are required to send back at least
                                <ul class="dashed">
                                    <li><span class="bg-warning">""" + f"""{payouts_df.iloc[i, 3]}""" + """</span> MINA to this address: <span class="bg-warning">""" + f"""{payouts_df.iloc[i, 0]}""" + """</span>
                                    </li>
                            ...
                            <li>Please send the block rewards back <span class="font-weight-bold"><b>before</b></span> slot 3500 of this epoch, which is in less than 4 days, on <span class="font-weight-bold bg-warning"><b>""" + f"""{deadline_date}""" + """ [TIME IN UTC]</b></span>.</li>
